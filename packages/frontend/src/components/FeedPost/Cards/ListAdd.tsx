 ...
 * @returns {JSX.Element}
 */
const ListAddPost: FC<FeedPostProps> = forwardRef(
  ({ isPreview, isVehiclePage, ...post }: FeedPostProps, ref: Ref<HTMLDivElement>) => {
    ...
    return (
      <StyledCard elevation={0} ref={ref}>
        <CardContent ref={rootRef}>
          ...
          <GenericText
            content={`Added to List ${window.origin}/lists/${subject_uuid}`}
            padding="8px"
          />
